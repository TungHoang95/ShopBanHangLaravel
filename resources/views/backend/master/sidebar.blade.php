<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<form role="search">
          ...
          <ul class="nav menu">
                ...
                <li><a href="/admin/about"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad" /></svg> Giới thiệu</a></li>
                <li role="presentation" class="divider"></li>
                <li><a href="/admin/contact"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad" /></svg> Liên hệ </a></li>
                <li><a href="/admin/inforcompany"><svg class="glyph stroked notepad"><use xlink:href="#stroked-notepad"></use></svg> Thông tin công ty </a></li>
