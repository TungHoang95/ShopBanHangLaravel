...
@section('title','chi tiết hóa đơn sản phẩm')
@section('content')
	<!--main-->
						...
						<div class="bootstrap-table">
							<div class="table-responsive">
											...
											<div class="panel panel-blue">
												...
												<div class="panel-body">
													<strong><span class="glyphicon glyphicon-user" aria-hidden="true"></span>
														: {{ $order->full }}</strong> <br>
													<strong><span class="glyphicon glyphicon-phone" aria-hidden="true"></span>
														: {{ $order->phone }}</strong>
													<br>
													<strong><span class="glyphicon glyphicon-send" aria-hidden="true"></span>
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th>
												<h4 align='right' style="color: brown;">{{ number_format($order->total,0,"",".") }}đ</h4>
											</th>
								...
								<div class="alert alert-primary" role="alert" align='right'>
									<a onclick="return confirm('Đơn hàng sau khi sử lý sẽ được tính vào phần doanh thu')"  class="btn btn-success" href="/admin/order/paid/{{$order->id}}" role="button">Xử lý</a>
								</div>
							</div>
						</div>
