        ...
        <div class="row">
            <div class="col-xs-6 col-md-12 col-lg-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">Sửa sản phẩm :{{$products->product_name}}</div>
                         @if(session('thongbao'))
                        ...
                        <div class="row" style="margin-bottom:40px">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <select name="category" class="form-control">
                                                {{ getCategory($categorys,0,"",$products->category_id) }}
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  name="featured" class="form-control">
                                                <option @if($products->featured == 0) selected @endif value="0">Mới</option>
                                                <option @if($products->featured == 1) selected @endif value="1">Nổi bật</option>
                                                <option @if($products->featured == 2) selected @endif value="2">Sale</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img id="avatar" class="thumbnail" width="100%" height="350px" src="img/{{$products->img}}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Miêu tả</label>
                                        <textarea id="editor"  name="describe" style="width: 100%;height: 100px;">
                                            {{ $products->describe }}</textarea>
                                    </div>
