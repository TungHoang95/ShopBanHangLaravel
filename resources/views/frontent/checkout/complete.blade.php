...
@section('title','thông báo mua hàng thành công')
@section('content')
		<!-- main -->
							...
							<div class="order-wrapper mt-50">
								...
								<div class="order-list">
									<div class="list-row d-flex justify-content-between">
										<div class="col-md-4"><u><i>SẢN PHẨM</i></u></div>
                                        <div class="col-md-4" align='right'><u><i>SỐ LƯỢNG</i></u></div>
										<div class="col-md-4 offset-md-4" align='right'><u><i>TỔNG CỘNG</i></u></div>
                                    </div>
