								...
								<div class="col-md-7">
									<form action="/cart/add" method="get">
										...
										<div class="desc">
											...
											<p class="price">
                                                @if($prd->sale_price == 0)
                                                <p class="price"><span>{{ number_format($prd->price,0,',','.') }} đ</span>
                                                @else
                                                <p class="price"><span><strike>{{ number_format($prd->price,0,',','.') }} đ</span></strike></p>
                                                <p class="price"><span>{{ number_format($prd->sale_price,0,',','.') }} đ</span></p>
                                                @endif
											</p>
											<p><b> THÔNG TIN </b></p>
